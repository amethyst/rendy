...
impl<'a> TextureBuilder<'a> {
        ...
        B: Backend,
    {
        ...
        let (mut mip_levels, mut generate_mips) = match self.mip_levels {
        ...
        // gl backend doesn't support mips yet.
        let is_gl = rendy_core::Backend::which::<B>() == rendy_core::Backend::Gl;
        if is_gl {
            mip_levels = 1;
            generate_mips = false;
        }
