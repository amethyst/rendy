...
lazy_static::lazy_static! {
    static ref VERTEX: SpirvShader = SourceShaderInfo::new(
        ...
        concat!(env!("CARGO_MANIFEST_DIR"), "/src/meshes/shader.vert").into(),
        ShaderKind::Vertex,
        SourceLanguage::GLSL,
        "main",
    ).precompile().unwrap();
    ...
    static ref FRAGMENT: SpirvShader = SourceShaderInfo::new(
        ...
        concat!(env!("CARGO_MANIFEST_DIR"), "/src/meshes/shader.frag").into(),
        ShaderKind::Fragment,
        SourceLanguage::GLSL,
        "main",
    ).precompile().unwrap();
    ...
    B: hal::Backend,
{
    ...
    ) -> Result<MeshRenderPipeline<B>, rendy::core::hal::pso::CreationError> {
