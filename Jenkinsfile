            ...
            parallel {
                stage('Test on Linux / coverage') {
                    ...
                    steps {
                        withCredentials([string(credentialsId: 'codecov_token', variable: 'CODECOV_TOKEN')]) {
                            ...
                            sh 'cd rendy && cargo run --example init --no-default-features --features init,gl,vulkan'
                ...
                stage("Test on Windows") {
                    ...
                    steps {
                        ...
                        bat 'cd rendy && C:\\Users\\root\\.cargo\\bin\\cargo run --example init --no-default-features --features init,dx12,vulkan"'
                        echo 'Tests done!'
                    }
                }
                stage("Test on macOS") {
